...
struct Material {
	...
	Material(const Vec3f colour = Vec3f(0.2, 0.2, 0.2), const float shinyness = 64.0f, const float ks = 0.4, const Vec3f ambient = Vec3f(0.05,0.05,0.05), const float ka = 0.1,
