...
public:
	...
	static void drawNormal(const Vec3f &verts, const Vec3f *normal, Buffer<uint32_t>* px_buff,  const float sf = 0.3f);

	//Draws arrow for debugging
	static void drawArrow(const Vec3f& start, const Vec3f& end, Buffer<uint32_t>* px_buff);
